...
ERNO.renderers.CSS3DCubelet = (function(){
	...
	return function( cubelet ){
        ...
        // console.log(cubelet.cubeId);
        // if(cubelet.colors=='YOXXBX' ){
        //   // console.log(cubelet);
        //   // console.log(cubelet.colors+"--"+cubelet.front.color.name+"--"+cubelet.type);
        //   // console.log(cubelet.colors+"--"+cubelet.back.color.name+"--"+cubelet.type);
        // }
